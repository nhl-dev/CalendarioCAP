...
interface Props {
  hl: React.Dispatch<React.SetStateAction<boolean>>;
}

function Welcome({ hl }: Props) {
  ...
  function onMultiChange() {
    return item => {
      const selSports = xorBy(selectedSports, [item], 'id') as [];
      return setSelectedSports(selSports);
    };
  }
}
